...
import {mmiFctOrderFoTailwindConfig} from "../../fct/mmi-fct-order-front-office/src/runtime/config/tailwind.config"
import {useLogger} from "@nuxt/kit";

export default mmiFctOrderFoTailwindConfig

const logger = useLogger("tailwind.config.ts");
logger.info("mmiFctOrderTailwindConfig", mmiFctOrderFoTailwindConfig)